...
<div class="col-sm-8">
<input type="text" name="fatherName" id="fatherNmae"  class="form-control" required="required">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="MotherName" id="MotherNmae"  class="form-control" required="required">
</div>
</div>
