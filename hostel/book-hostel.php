...
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,fatherName,motherName,fatherWork,fatherContactNo,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssssisisississsisssi',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$fatherName,$motherName,$fatherWork,$fatherContactNo,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="fatherName" id="fatherName"  class="form-control" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Mother Name: </label>
<div class="col-sm-8">
<input type="text" name="motherName" id="MotherName"  class="form-control" required="required">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Father Work: </label>
<div class="col-sm-8">
<input type="text" name="fatherWork" id="fatherWork"  class="form-control" required="required">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Father Contact-No: </label>
<div class="col-sm-8">
<input type="text" name="fatherContactNo" id="fatherContactNo"  class="form-control" required="required">
</div>
</div>
